    ...
    <main className="max-w-6xl mx-auto px-4 sm:px-6 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <article className="lg:col-span-2 space-y-6">
          ...
          <div>
            <h2 className="text-sm font-bold text-gray-300 uppercase tracking-widest mb-4">Perspective Breakdown</h2>
            <CoverageSpectrum
          ...
          <div>
            <h2 className="text-sm font-bold text-gray-300 uppercase tracking-widest mb-4">All Sources ({articles.length})</h2>
              ...
              {articles.map((article, i) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-white line-clamp-2 group-hover:text-gold-300 transition-colors">{article.title}</p>
                    {article.summary && (
