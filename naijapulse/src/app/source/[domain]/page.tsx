...
export default async function SourcePage({ params }: Props) {
  ...
  // Build lean distribution for the BiasBar display of a single source
          ...
          {(articles ?? []).map((article: any, i: number) => (
            ...
            >
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-white leading-snug line-clamp-2 group-hover:text-gold-300 transition-colors">
                  {article.title}
                </p>
                {article.summary && (
